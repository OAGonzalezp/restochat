        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text("Chats", style: TextStyle(color: Singleton().getChatTitleColor()),),
            ),
              Column(
                children: chats.map((e) => Column(
                  children: [
                    ChatWidget(chat: e),
                    chats.indexOf(e) != chats.length - 1 ? Divider(indent: 80, height: 1, endIndent: 16,color: Singleton().getChatTitleColor(),) : SizedBox(),
                  ],
                )).toList(),
              ),
          ],
